    ...
    $('#reg-btn').click(function(){
        ...
        if(flag && agree == 'on'){
            $.ajax({
                ...
                dataType: 'json',
                data: "mobile="+mobile+"&captcha="+captcha+"&regtype="+regType+"&passwd="+password+"&confirmpass="+rePassword+"&agree="+agree+"&email="+email+"&pic="+pic+"&openid="+openid+"&wbuid="+wbuid+"&codeImg="+codeImg,
                success: function(msg) {
                    if(msg.ret == 1){
